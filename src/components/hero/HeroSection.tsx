...
const HeroSection = () => {
  ...
  return (
    <section className="py-6 bg-zinc-950 relative overflow-hidden">
      {/* Professional background effects matching games section */}
      <div className="absolute inset-0 pointer-events-none opacity-40">
        ...
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-emerald-400/60 rotate-45 animate-pulse"></div>
        <div className="absolute top-1/3 right-1/5 w-1 h-1 bg-cyan-400/60 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-1/3 left-1/4 w-3 h-3 border border-emerald-400/40 animate-pulse" style={{animationDelay: '4s'}}></div>
        <div className="absolute bottom-1/6 right-1/6 w-2 h-2 bg-purple-400/40 rotate-12 animate-pulse" style={{animationDelay: '6s'}}></div>
      </div>

      <div className="container mx-auto px-4 relative z-10">
        {/* Compact Studio Header */}
        <div className="text-center mb-5">
          <div className="inline-flex items-center bg-zinc-800/90 border border-emerald-500/50 px-3 py-1 mb-2 backdrop-blur-sm">
          ...
          <p className="text-sm text-zinc-400 max-w-xl mx-auto mb-3">
          ...
          <div className="flex flex-wrap justify-center gap-1 mb-3">
            {products.map((product, index) => {
              ...
              return (
                <div key={index} className="flex items-center space-x-1 group bg-zinc-800/80 border border-zinc-700 px-2 py-1">
                  ...
                  {index < products.length - 1 && <span className="text-zinc-600 mx-1">•</span>}
                </div>
              );
            })}
          </div>
        ...
        {/* Main Content Grid - Updated with grey panels */}
        <div className="grid lg:grid-cols-2 gap-3 mb-5">
          {/* Left Panel - Terminal */}
          <div className="bg-zinc-900/50 border border-zinc-700/50 p-3 backdrop-blur-sm">
            <ProfessionalTerminal />
          </div>

          {/* Right Panel - Action Center */}
          <div className="bg-zinc-900/50 border border-zinc-700/50 p-4 space-y-3 backdrop-blur-sm">
            ...
            <div className="space-y-2">
              <div className="bg-zinc-800/50 border border-zinc-700/50 p-2 border-l-2 border-l-emerald-400">
              ...
              <div className="bg-zinc-800/50 border border-zinc-700/50 p-2 border-l-2 border-l-cyan-400">
              ...
              <div className="bg-zinc-800/50 border border-zinc-700/50 p-2 border-l-2 border-l-purple-400">
            ...
            <div className="flex flex-col gap-2 pt-2">
              <Link to="/blog" className="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-black px-4 py-2 font-black text-sm transition-all duration-300 flex items-center justify-center space-x-2">
                <Rocket className="w-4 h-4" />
                <span>EXPLORE ECOSYSTEM</span>
                <ArrowRight className="w-4 h-4" />
              </Link>
              
              <a href="https://github.com/orgs/JBLinx-Studio/repositories" target="_blank" rel="noopener noreferrer" className="border border-emerald-400/60 text-emerald-400 hover:border-emerald-300 hover:text-emerald-300 hover:bg-emerald-400/10 px-4 py-2 font-black text-sm transition-all duration-300 flex items-center justify-center space-x-2">
