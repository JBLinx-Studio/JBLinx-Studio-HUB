...
const HeroSection = () => {
  ...
  return <section className="py-6 bg-gradient-to-b from-slate-950 to-slate-900 border-t border-slate-800 bg-zinc-900">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-5">
          ...
          <div className="flex flex-wrap justify-center gap-1 mb-3">
            ...
            return <div key={index} className="flex items-center space-x-1 group bg-slate-800/80 px-2 py-1 border border-slate-700">
          ...
          <div className="grid grid-cols-4 gap-1 max-w-xl mx-auto mb-4">
            ...
            return <div key={index} className={`${colorClasses[stat.color]} border-2 backdrop-blur-sm p-1.5 text-center transition-all duration-300 hover:scale-105 hover:shadow-xl group cursor-pointer`}>
