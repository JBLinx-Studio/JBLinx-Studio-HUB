    ...
    <section id="home" className="relative min-h-screen flex items-center bg-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-5" style={{
          backgroundImage: `radial-gradient(circle at 25px 25px, rgb(var(--color-primary-500)) 2px, transparent 0)`,
      ...
      <div className="theme-container relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          {/* Left Content */}
          <div className="animate-on-scroll theme-animate-fade-in">
            {/* Status Badge */}
            ...
            {/* Main Headline */}
            <h1 className="theme-heading-primary mb-8">
              Digital Solutions
            ...
            {/* Description */}
            <p className="theme-body-text mb-12 max-w-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
              {[
                ...
                <div key={index} className="theme-card p-4 hover:shadow-md transition-all duration-300">
                  <div className={`w-12 h-12 bg-gradient-to-r ${feature.color} rounded-xl flex items-center justify-center shadow-lg mb-3`}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 mb-16">
              <a 
                href="#contact" 
                className="theme-button-primary group"
              >
                Get Started Today
              ...
              <a 
                href="#portfolio" 
                className="theme-button-secondary group"
              >
          ...
          <div className="relative animate-on-scroll theme-animate-fade-in">
            <div className="relative">
              <div className="theme-card p-12 shadow-2xl">
                {/* Tech Stack Grid */}
