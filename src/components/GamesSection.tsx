...
const GamesSection = () => {
  ...
  const games = [
    {
      id: 1, title: "Tactical Strike: Cyber Assault", tagline: "Dominate the digital battlefield",
      category: "Action/Strategy", genres: ["Cyberpunk", "Tactical", "Sci-Fi"],
      platforms: ["PC", "Mobile", "Web Browser"], status: "LIVE", releaseDate: "2024-08-15",
      price: { base: 49.99, sale: null, currency: "USD" }, rating: 4.7, playerCount: "10k+", reviewCount: 2450,
      images: { hero: "", gallery: [] }, trailer: "",
    ...
    {
      id: 2, title: "Empire Conquest: Age of Kings", tagline: "Forge your empire, command your legions",
      category: "Strategy/RPG", genres: ["Medieval", "Strategy", "RPG"],
      platforms: ["PC", "Web Browser"], status: "BETA", releaseDate: "2024-11-01",
      price: { base: 0, sale: null, currency: "USD" }, rating: 4.5, playerCount: "20k+", reviewCount: 1800,
      images: { hero: "", gallery: [] }, trailer: "",
      ...
      systemReqs: { min: "", recommended: "" }, dlc: [],
      stats: { peakPlayers: 25000, averageSession: "3 hours", retention: "70%", esportsReady: false },
      storeLinks: {}
    },
    {
      id: 3, title: "Last Haven: Zombie Outbreak", tagline: "Survive the apocalypse, rebuild humanity",
      category: "Survival/Horror", genres: ["Zombie", "Survival", "Horror"],
      platforms: ["PC", "PlayStation", "Xbox"], status: "EARLY_ACCESS", releaseDate: "2025-03-10",
      price: { base: 29.99, sale: 24.99, currency: "USD" }, rating: 4.2, playerCount: "5k+", reviewCount: 950,
      images: { hero: "", gallery: [] }, trailer: "",
    ...
    {
      id: 4, title: "Stellar Frontier: Space Odyssey", tagline: "Explore the cosmos, build your empire",
      category: "Sci-Fi/Strategy", genres: ["Space", "Strategy", "Sci-Fi"],
      platforms: ["PC", "Mobile"], status: "COMING_SOON", releaseDate: "2025-06-20",
      price: { base: 0, sale: null, currency: "USD" }, rating: 0, playerCount: "0", reviewCount: 0,
      images: { hero: "", gallery: [] }, trailer: "",
  ...
  const getStatusColor = (status: string) => {
    switch(status) {
      ...
      case 'EARLY_ACCESS': return 'status-early-access';
  ...
  return (
    <section id="games" className="relative section-padding overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <AnimatedSection>
          <div className="section-header">
            ...
            <h2 className="text-section-title text-foreground mb-3">
              WHAT WE <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">PLAY</span>
            </h2>
              ...
              return (
                <motion.div 
                  ...
                  className={`panel card-padding cursor-pointer transition-all duration-300 ${
                    isActive ? 'border-purple-500/60 shadow-lg shadow-purple-500/10' : 'hover:border-border/80'
                  }`}
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="w-10 h-10 bg-purple-500/15 border border-purple-500/40 rounded-lg flex items-center justify-center">
                      <Gamepad2 className="w-5 h-5 text-purple-400" />
                    </div>
                    <span className={`px-2 py-1 text-xs font-bold rounded-sm ${getStatusColor(game.status)}`}>
                  ...
                  <div className="flex flex-wrap gap-1 mb-3">
                    {game.genres.slice(0, 2).map((genre, genreIndex) => (
                      <span key={genreIndex} className={`tag text-xs ${isActive ? 'bg-purple-500/15 border-purple-500/40 text-purple-400' : 'tag-default'}`}>
                        {genre}
                      </span>
                    ))}
                  </div>
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 text-label rounded-md transition-all ${
        ...
        <AnimatedSection delay={0.4}>
          <div className="panel-elevated mb-12">
            ...
            {selectedPanel === 'community' && (
              <div className="card-padding text-center py-12">
                <Users className="w-14 h-14 mx-auto mb-4 text-purple-400" />
        ...
        <AnimatedSection className="text-center" delay={0.5}>
          ...
          <Link to="/game-development" className="btn-primary bg-purple-500 hover:bg-purple-600 shadow-purple-500/30">
