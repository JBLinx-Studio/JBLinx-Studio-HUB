...
const Contact = () => {
  ...
  const quickActions = [
    { icon: MessageCircle, label: "START CHAT", color: "bg-emerald-500 hover:bg-emerald-600 shadow-emerald-500/30" },
    { icon: Calendar, label: "BOOK MEETING", color: "bg-blue-500 hover:bg-blue-600 shadow-blue-500/30" },
    { icon: Phone, label: "REQUEST CALL", color: "bg-orange-500 hover:bg-orange-600 shadow-orange-500/30" }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <AnimatedSection>
          <div className="section-header">
            ...
            <h2 className="text-section-title text-foreground mb-3">
              LET'S BUILD <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-400">TOGETHER</span>
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {contactMethods.map((method, index) => {
              ...
              return (
                <motion.div 
                  key={index} 
                  className="panel card-padding hover:border-orange-500/40 transition-all"
                  whileHover={{ y: -3 }}
                  transition={{ duration: 0.2 }}
                >
                  <div className="flex flex-col items-center text-center">
                    <div className="w-12 h-12 bg-secondary border border-border rounded-lg flex items-center justify-center mb-3">
        ...
        <AnimatedSection delay={0.3}>
          <div className="grid lg:grid-cols-2 gap-6">
            {/* Contact Form */}
            <div className="panel-elevated card-padding">
              ...
              <form className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="email" className="input-base" placeholder="john@example.com" required />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea rows={4} className="input-base resize-none" placeholder="Tell us about your project..." required />
                </div>
                ...
                <div className="space-y-3">
                  {quickActions.map((action, index) => {
                    ...
                    return (
                      <motion.button 
                        key={index} 
                        className={`btn-base w-full text-white rounded-md shadow-lg ${action.color}`}
